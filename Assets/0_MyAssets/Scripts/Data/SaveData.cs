...
public class SaveData : ISerializationCallbackReceiver
{
    ...
    //=================================================================================
    public float[] spectrum_Hina = new float[8192];
    public float[] spectrum_Hina2 = new float[8192];
    public float[] spectrum_Hina3 = new float[8192];
    public float[] spectrum_Hina4 = new float[8192];
    public float[] spectrum_Hina5 = new float[8192];
    public float[] spectrum_Hina6 = new float[8192];
    public float[] spectrum_SatoshiNakamura = new float[8192];
    public float[] spectrum_MasanoriMorise = new float[8192];
